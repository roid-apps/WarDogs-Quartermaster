...
### Build your kit. Plan the operation. Bring your squad.
...
Open **Team server**, name your team and choose **Start hosting**. Friends paste the invite into **Join a team**. The app can download the free Cloudflare helper, or use an existing installation.

- Up to **16 members**, with dynamic presence, roles, selected loadouts and readiness.
- Chat, briefing, objectives and shared boards; the host saves the workspace between sessions.
...
| --- | --- |
| **Armory** | Browse pictures for 491 equipment records, compare reference fields, save favorites and filter prices. |
| **Purchase manifest** | Plan cargo and quantities, confirm sale units, track owned unlocks and separate unlock fees from repeat purchases. |
| **Cash planning** | Record balances, purchases and rewards; estimate repeat-kit affordability above your chosen reserve. |
| **After action** | Record K/D/A, reconcile scoreboard totals, keep session history and write match-review notes. |
| **XP & economy** | Track your entered progression and explore explicitly entered reward scenarios. |
...
1. Download the Windows EXE above and open it.
2. Set your name, role and picture in Settings.
3. Open Loadout workshop to build a kit, or Tactical board to plan on a map.
4. Use Team server when you want to plan with friends.

The EXE is unsigned. It is a standalone companion with manual records: no game-memory reading, input automation, screen capture, Steam sign-in or automatic combat tracking. A game overlay is not included. The app does not automatically download new releases; download a newer EXE when updating.

Personal data stays in the app's local data folder, with backup export/restore in Settings. Hosted team content has a separate file and previous-copy backup. See [Privacy](PRIVACY.md) for what a room shares and stores.

Equipment numbers retain the **September 22, 2026 community snapshot** or your overrides. The September 25 source-index review did not refresh all prices. Missing values stay unknown; check current prices, availability, sale units and compatibility in game. No publisher approval or live-game compatibility certification is claimed.

Screenshots use isolated demo profiles and example plans, not live gameplay or personal records. Reference artwork belongs to its respective owners; [Wardogs Zone](https://wardogs.zone/), [WarDogs Hub](https://wardogshub.gg/) and [WarDogs HQ](https://wardogshq.gg/) are credited in the app. Runtime licenses and third-party notices accompany each release.

Independent fan project, not affiliated with BULKHEAD or Team17. This repository provides downloads, screenshots and product documentation.
